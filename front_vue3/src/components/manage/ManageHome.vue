        ...
        <div class="ManageIndex-out-div">
            <el-card class="ManageIndex-el-card">
                ...
                <el-card class="manageHome-el-card">
                    <el-tabs
                        v-model="headActiveTabs"
                        @tab-change="headTabChange"
                    >
                    ...
                    <el-button
                        v-if="headSubmit == true"
                        @click="clickHeadApply()"
                        type="danger"
                        class="manageHome-submit-button"
                        plain
                    >
                ...
                <div
                    ...
                    class="IndexAbout-outside-div-style"
                >
                    <el-card
                        class="common-with-back-el-card-style"
                        :style="card1"
                ...
                <el-card class="manageHome-el-card">
                    <el-tabs
                        v-model="aboutActiveTabs"
                        @tab-change="aboutTabChange"
                    >
                        <el-tab-pane label="简体中文" name="zh"> </el-tab-pane>
                        <el-tab-pane label="english" name="en"> </el-tab-pane>
                        <el-tab-pane label="warma" name="warma"> </el-tab-pane>
