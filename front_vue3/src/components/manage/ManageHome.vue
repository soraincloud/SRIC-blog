    ...
    <div class="ManageIndex-out-div">
        <el-card class="ManageIndex-el-card">
            ...
            <el-card class="manageHome-el-card">
                ...
                <el-input v-model="indexHeadTitle" maxlength="20" show-word-limit type="text" style="margin-bottom: 10px"
                    @blur="headTitleBlur" />
                <el-input v-model="indexHead" maxlength="100" show-word-limit type="textarea" @blur="headBlur" />
                <el-button v-if="headSubmit == false" @click="clickHeadSubmit()" type="danger" class="manageHome-submit-button" plain>
                    {{ $t('common.submit') }}
                </el-button>
                <el-button v-if="headSubmit == true" @click="clickHeadApply()" type="danger" class="manageHome-submit-button" plain>
                    {{ $t('common.apply') }}
                </el-button>
                <el-button v-if="headSubmit == true" @click="clickHeadCancel()" type="info" class="manageHome-submit-button" plain>
                    {{ $t('common.cancel') }}
                </el-button>
                <span class="manageHome-submit-text">{{ headSubmitText }}</span>
            </el-card>
        </el-card>
    </div>
</template>
