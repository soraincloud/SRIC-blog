...
<template>
    <div @mouseover="mouseOver" @mouseleave="mouseLeave" class="IndexAside-el-card-div-style">
        <el-card class="IndexAside-el-card-style" :style="[active,top]">
...
<script>
    import indexaside from "@/assets/js/home/IndexAside.js"
